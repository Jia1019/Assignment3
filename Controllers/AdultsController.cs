...
namespace WebApplication.Controllers
{
    ...
    public class AdultsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IList<Adult>>> GetAdults()
        {
            try
            {
                IList<Adult> adults = familyService.GetAdults();
        ...
        public async Task<ActionResult<Adult>> GetAdultByID([FromQuery] int id)
        {
            try
            {
                Adult adult = familyService.getAdultById(id);
        ...
        public async Task<ActionResult<string>> AddAdult([FromBody] Adult adult)
        {
            try
            {
                string result =familyService.AddAdult(adult);
                return Ok(result);
            }
            catch (Exception e)
            {
        ...
        public async Task UpdateAdult([FromBody] Adult adult)
        {
            try
            {
                familyService.UpdateAdult(adult);
            }
            catch (Exception e)
            {
                Console.WriteLine(e);
